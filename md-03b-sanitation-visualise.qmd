...
1.  Look at the plot that you created. What do you notice about the order of the bars / order of the legend? **the order was generated randomly with no relation to the order of the sanitation ladder. The same applies to the legend.**
2.  What would you want to change? **I will change the order of the bars to represent the order of the sanitation ladder. I will change the colours as well to represent actual colours in the sanitation ladder.**
3.  Why did we remove "safely managed sanitation services" from the data set in Task 3? **I believe it was removed because it is not of a concern compared to the rest of the indicators on the ladder. It is on top of the sanitation ladder and if no one achieves at all, it wont have any major impact on the populace.**

## Task 7

1.  Run the code in the code chunk below.
2.  What do you observe when you look at the code and plot? **The results shows the distribution of the percent coverage for individual indicators according to the type of residence for the year 2020.**
